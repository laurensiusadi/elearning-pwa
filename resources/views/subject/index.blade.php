            ...
            <table id="datatable" class="table highlight bordered">
    			...
    			<tbody>
    				...
    				<tr>
    					...
    					<td data-label="Aksi">
                            <a class="btn btn-small amber tooltipped" data-position="bottom" data-delay="50" data-tooltip="Edit" href="#modal{{ $subject->id }}edit"><i class="material-icons">edit</i></a>
                            @include('subject.editmodal')
